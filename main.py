...
def predict_linear(data: LinearInput):
    ...
    try:
        ...
        # if input.ndim != 2 or input.shape[1] != expected_feature_count:
        #     raise HTTPException(status_code=422, detail=f"Expected input with shape (n, {expected_feature_count})")
